...
--	DECLARE @discipline_2			SMALLINT	= (SELECT discipline_id FROM Disciplines WHERE discipline_name LIKE N'Процедурное программирование %C++%');
--	DECLARE @number_of_lessons_1	SMALLINT	= (SELECT number_of_lessons FROM Disciplines WHERE discipline_name LIKE N'Hardware%');
--	DECLARE @number_of_lessons_2	SMALLINT	= (SELECT number_of_lessons FROM Disciplines WHERE discipline_name LIKE N'Процедурное программирование %C++%');
