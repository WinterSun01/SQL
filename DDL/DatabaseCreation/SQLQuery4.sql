...
(
	...
	CONSTRAINT	FK_TRD_Discipline	FOREIGN KEY (discipline) REFERENCES Disciplines(discipline_id)
);
...
(
	...
	CONSTRAINT	FK_CompleteDiscipline_Groups	FOREIGN KEY ([group]) REFERENCES Groups(group_id),
